...
public class BookSystem extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class Bookforsale {
    ...
    /**
     * Create a request for the method "bookforsale.getAllBooksForSaleBySeller".
     *
     * This request holds the parameters needed by the the bookSystem server.  After setting any
     * optional parameters, call the {@link GetAllBooksForSaleBySeller#execute()} method to invoke the
     * remote operation.
     *
     * @param personId
     * @return the request
     */
    public GetAllBooksForSaleBySeller getAllBooksForSaleBySeller(java.lang.Long personId) throws java.io.IOException {
      GetAllBooksForSaleBySeller result = new GetAllBooksForSaleBySeller(personId);
      initialize(result);
      return result;
    }

    public class GetAllBooksForSaleBySeller extends BookSystemRequest<com.appspot.mac_books.bookSystem.model.BookForSaleCollection> {

      private static final String REST_PATH = "bookforsalecollection/{personId}";
       ...
       * This request holds the parameters needed by the the bookSystem server.  After setting any
       * optional parameters, call the {@link GetAllBooksForSaleBySeller#execute()} method to invoke the
       * remote operation. <p> {@link GetAllBooksForSaleBySeller#initialize(com.google.api.client.google
       ...
       * @since 1.13
       */
      protected GetAllBooksForSaleBySeller(java.lang.Long personId) {
        super(BookSystem.this, "GET", REST_PATH, null, com.appspot.mac_books.bookSystem.model.BookForSaleCollection.class);
        this.personId = com.google.api.client.util.Preconditions.checkNotNull(personId, "Required parameter personId must be specified.");
      }
      ...
      @Override
      public GetAllBooksForSaleBySeller setAlt(java.lang.String alt) {
        return (GetAllBooksForSaleBySeller) super.setAlt(alt);
      }

      @Override
      public GetAllBooksForSaleBySeller setFields(java.lang.String fields) {
        return (GetAllBooksForSaleBySeller) super.setFields(fields);
      }

      @Override
      public GetAllBooksForSaleBySeller setKey(java.lang.String key) {
        return (GetAllBooksForSaleBySeller) super.setKey(key);
      }

      @Override
      public GetAllBooksForSaleBySeller setOauthToken(java.lang.String oauthToken) {
        return (GetAllBooksForSaleBySeller) super.setOauthToken(oauthToken);
      }

      @Override
      public GetAllBooksForSaleBySeller setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (GetAllBooksForSaleBySeller) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public GetAllBooksForSaleBySeller setQuotaUser(java.lang.String quotaUser) {
        return (GetAllBooksForSaleBySeller) super.setQuotaUser(quotaUser);
      }

      @Override
      public GetAllBooksForSaleBySeller setUserIp(java.lang.String userIp) {
        return (GetAllBooksForSaleBySeller) super.setUserIp(userIp);
      }
      ...
      public GetAllBooksForSaleBySeller setPersonId(java.lang.Long personId) {
        this.personId = personId;
        return this;
      }

      @Override
      public GetAllBooksForSaleBySeller set(String parameterName, Object value) {
        return (GetAllBooksForSaleBySeller) super.set(parameterName, value);
      }
    }
    /**
    ...
    /**
     * Create a request for the method "bookforsale.listBooksAndSellers".
     *
     * This request holds the parameters needed by the the bookSystem server.  After setting any
     * optional parameters, call the {@link ListBooksAndSellers#execute()} method to invoke the remote
     * operation.
     *
     * @return the request
     */
    public ListBooksAndSellers listBooksAndSellers() throws java.io.IOException {
      ListBooksAndSellers result = new ListBooksAndSellers();
      initialize(result);
      return result;
    }

    public class ListBooksAndSellers extends BookSystemRequest<com.appspot.mac_books.bookSystem.model.JsonMap> {

      private static final String REST_PATH = "listBooksAndSellers";
       ...
       * This request holds the parameters needed by the the bookSystem server.  After setting any
       * optional parameters, call the {@link ListBooksAndSellers#execute()} method to invoke the remote
       * operation. <p> {@link ListBooksAndSellers#initialize(com.google.api.client.googleapis.services.
       * AbstractGoogleClientRequest)} must be called to initialize this instance immediately after
       * invoking the constructor. </p>
       *
       * @since 1.13
       */
      protected ListBooksAndSellers() {
        super(BookSystem.this, "GET", REST_PATH, null, com.appspot.mac_books.bookSystem.model.JsonMap.class);
      }
      ...
      @Override
      public ListBooksAndSellers setAlt(java.lang.String alt) {
        return (ListBooksAndSellers) super.setAlt(alt);
      }

      @Override
      public ListBooksAndSellers setFields(java.lang.String fields) {
        return (ListBooksAndSellers) super.setFields(fields);
      }

      @Override
      public ListBooksAndSellers setKey(java.lang.String key) {
        return (ListBooksAndSellers) super.setKey(key);
      }

      @Override
      public ListBooksAndSellers setOauthToken(java.lang.String oauthToken) {
        return (ListBooksAndSellers) super.setOauthToken(oauthToken);
      }

      @Override
      public ListBooksAndSellers setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (ListBooksAndSellers) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public ListBooksAndSellers setQuotaUser(java.lang.String quotaUser) {
        return (ListBooksAndSellers) super.setQuotaUser(quotaUser);
      }

      @Override
      public ListBooksAndSellers setUserIp(java.lang.String userIp) {
        return (ListBooksAndSellers) super.setUserIp(userIp);
      }

      @Override
      public ListBooksAndSellers set(String parameterName, Object value) {
        return (ListBooksAndSellers) super.set(parameterName, value);
      }
    }
    /**
     * Create a request for the method "bookforsale.updatePrice".
     *
     * This request holds the parameters needed by the the bookSystem server.  After setting any
     * optional parameters, call the {@link UpdatePrice#execute()} method to invoke the remote
     * operation.
     *
     * @param email
     * @param isbn
     ...
     * @return the request
     */
    public UpdatePrice updatePrice(java.lang.String email, java.lang.String isbn, java.lang.Double price) throws java.io.IOException {
      UpdatePrice result = new UpdatePrice(email, isbn, price);
      initialize(result);
      return result;
    }

    public class UpdatePrice extends BookSystemRequest<com.appspot.mac_books.bookSystem.model.IntegerResponse> {

      private static final String REST_PATH = "integerresponse/{email}/{isbn}/{price}";
       ...
       * optional parameters, call the {@link UpdatePrice#execute()} method to invoke the remote
       * operation. <p> {@link
       * UpdatePrice#initialize(com.google.api.client.googleapis.services.AbstractGoogleClientRequest)}
       * must be called to initialize this instance immediately after invoking the constructor. </p>
       *
       * @param email
       * @param isbn
       ...
       * @since 1.13
       */
      protected UpdatePrice(java.lang.String email, java.lang.String isbn, java.lang.Double price) {
        super(BookSystem.this, "PUT", REST_PATH, null, com.appspot.mac_books.bookSystem.model.IntegerResponse.class);
        this.email = com.google.api.client.util.Preconditions.checkNotNull(email, "Required parameter email must be specified.");
        this.isbn = com.google.api.client.util.Preconditions.checkNotNull(isbn, "Required parameter isbn must be specified.");
        this.price = com.google.api.client.util.Preconditions.checkNotNull(price, "Required parameter price must be specified.");
      }
      ...
      @Override
      public UpdatePrice setAlt(java.lang.String alt) {
        return (UpdatePrice) super.setAlt(alt);
      }

      @Override
      public UpdatePrice setFields(java.lang.String fields) {
        return (UpdatePrice) super.setFields(fields);
      }

      @Override
      public UpdatePrice setKey(java.lang.String key) {
        return (UpdatePrice) super.setKey(key);
      }

      @Override
      public UpdatePrice setOauthToken(java.lang.String oauthToken) {
        return (UpdatePrice) super.setOauthToken(oauthToken);
      }

      @Override
      public UpdatePrice setPrettyPrint(java.lang.Boolean prettyPrint) {
        return (UpdatePrice) super.setPrettyPrint(prettyPrint);
      }

      @Override
      public UpdatePrice setQuotaUser(java.lang.String quotaUser) {
        return (UpdatePrice) super.setQuotaUser(quotaUser);
      }

      @Override
      public UpdatePrice setUserIp(java.lang.String userIp) {
        return (UpdatePrice) super.setUserIp(userIp);
      }
      ...
      public UpdatePrice setEmail(java.lang.String email) {
        this.email = email;
        return this;
      }
      ...
      public UpdatePrice setIsbn(java.lang.String isbn) {
        this.isbn = isbn;
        return this;
      }
      ...
      public UpdatePrice setPrice(java.lang.Double price) {
        this.price = price;
        return this;
      }

      @Override
      public UpdatePrice set(String parameterName, Object value) {
        return (UpdatePrice) super.set(parameterName, value);
      }
    }
